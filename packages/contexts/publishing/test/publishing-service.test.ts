...
const qualification = {
  capability: {
    constraints: {},
    submissionModes: ["automatic", "manual_confirmation"] as const,
  },
};
...
function start(service: PublishingService): PublicationSnapshot {
...
describe("PublishingService", () => {
  ...
  it("does not create a publication that fails domain qualification", () => {
    const { repository, service } = fixture();
